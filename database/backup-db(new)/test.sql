...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2025 at 08:18 AM
...
(11, 'ww', NULL, NULL, NULL, NULL, NULL, 'sulit', 'paham', 0, 'admin', 'ww', '2025-05-03 06:26:57', 'essay');
...
(4, 21101140, '11q', '2025-04-26', '2025-04-27', 100, 'aktif', 2, 'manual'),
(5, 21101140, 'hahaha', '2025-04-30', '2025-05-01', 2, 'aktif', 6, 'manual'),
(6, 21101140, 'xaxax', '2025-04-27', '2025-04-28', 100, 'aktif', 2, 'manual'),
(8, 21101140, 'UTS', '2025-05-03', '2025-05-04', 2, 'aktif', 6, 'bank_soal'),
(9, 21101140, 'UTS', '2025-05-03', '2025-05-04', 2, 'aktif', 6, 'bank_soal'),
(10, 21101140, 'UTS', '2025-05-03', '2025-05-04', 2, 'aktif', 6, 'bank_soal'),
(11, 21101140, 'UTS', '2025-05-03', '2025-05-04', 2, 'aktif', 6, 'manual');
...
--
ALTER TABLE `ujian_soal`
  ADD CONSTRAINT `ujian_soal_ibfk_1` FOREIGN KEY (`ujian_id`) REFERENCES `tbl_ujian` (`id_ujian`),
  ADD CONSTRAINT `ujian_soal_ibfk_2` FOREIGN KEY (`soal_id`) REFERENCES `bank_soal` (`id_soal`);
COMMIT;
