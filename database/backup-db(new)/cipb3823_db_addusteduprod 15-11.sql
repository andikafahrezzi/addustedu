...
--
-- Host: localhost:3306
-- Generation Time: Nov 15, 2025 at 05:15 PM
...
--
-- Database: `cipb3823_db_addusteduprod`
--
...
(7, 1, '0095416290', 'tidak_hadir', '2025-11-15 17:14:47', '2025-11-15 17:14:47', '818ea84bcea0a73be5190ca1f91d1fea', '2025-11-15 17:14:47'),
(8, 1, '0128301889', 'tidak_hadir', '2025-11-15 17:14:47', '2025-11-15 17:14:47', '818ea84bcea0a73be5190ca1f91d1fea', '2025-11-15 17:14:47'),
(9, 1, '3146882349', 'tidak_hadir', '2025-11-15 17:14:47', '2025-11-15 17:14:47', '818ea84bcea0a73be5190ca1f91d1fea', '2025-11-15 17:14:47');
...
(1, 'apaapa', 'aaa', 'aaa', 'aaa', 'aaa', 'A', 'sedang', 'paham', '1282023001', 'guru', '2025-09-21 12:57:55', 'pilihan', 1);
...
(1, 'guru', '1282023001', 1, NULL, 'izin bertanya pak', '2025-09-21 13:11:29', '2025-09-21 13:11:51', '2025-09-21 13:11:51'),
(2, 'siswa', '0095416290', 1, 1, 'test', '2025-09-21 11:20:21', '2025-09-21 11:20:21', '2025-09-21 11:20:21'),
(3, 'siswa', '0095416290', 1, NULL, 'test', '2025-09-21 11:01:10', '2025-11-12 08:06:37', NULL),
(4, 'siswa', '0128301889', 1, NULL, 'halo', '2025-09-21 11:02:05', '2025-11-12 08:12:21', NULL),
(5, 'siswa', '0128301889', 1, 3, 'ya', '2025-09-21 11:03:50', '2025-11-12 08:12:41', NULL),
(6, 'guru', '1282023001', 1, NULL, 'halo anak murid', '2025-09-21 13:11:51', '2025-11-12 08:11:21', NULL),
(7, 'siswa', '0095416290', 1, NULL, 'tes', '2025-11-15 17:14:21', NULL, NULL),
(8, 'siswa', '0095416290', 1, 5, 'test', '2025-11-15 17:14:39', NULL, NULL);
...
CREATE TABLE `guru_mapel` (
  `id` int(11) NOT NULL,
  `id_guru` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
(1, '1282023001', 1, 1, 'https://www.youtube.com/embed/fJOI98Z_R58?rel=0&modestbranding=1', 'mohon dipelajari', ' ', 'WhatsApp_Image_2023-12-02_at_21_39_57.jpeg');
...
(1, 1, 'Sejarah indo', 'mohon disi', 30, 1, 1, '2025-09-21 13:16:10');
...
CREATE TABLE `quiz_siswa` (
  `id` int(11) NOT NULL,
  `quiz_id` int(11) NOT NULL,
  `siswa_id` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
('987654321', 'addust', '$2y$10$2VkAjzq3HwVe2HD.Ggdkhe.6CEQLoGyyuWhuCMqoPVl5SP23QCwk2', 'siswa@gmail.com', 'default.jpg', 1, '2025-10-10', 3, 'siswa'),
...
('99999999', 'MAx Verstapen', '$2y$10$jZcvd6xU8/1x2ckNrWLXmOGzLLJNGzOIrorLVF7.W8HDhNU7bV3Ce', 'test@gmail.com', 'default.jpg', 1, '2025-09-21', 3, 'siswa');
...
CREATE TABLE `tbl_jawaban_siswa` (
  ...
  `nis` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE `tbl_ujian` (
  ...
  `nip_guru` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
