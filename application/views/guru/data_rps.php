...
<div class="main-content">
    <section class="section">
        <div class="card" style="width:100%;">
            <div class="card-body">
                <h2 class="card-title" style="color: black;">Daftar RPS Saya</h2>
                <hr>
                <p class="card-text">Berikut daftar RPS yang telah Anda upload. Anda dapat melihat, mengubah, atau menambahkan RPS baru.</p>
                <a href="<?= base_url('rps/upload_rps') ?>" class="btn btn-success">
                    <i class="fas fa-plus"></i> Upload RPS Baru
                </a>
            </div>
        </div>
...
<?php if(!empty($rps_grouped)) : ?>
    ...
    <?php foreach($rps_grouped as $group => $items) : ?>
        <tr class="table-info">
            <td colspan="6" style="font-weight:bold"><?= $group ?></td>
        </tr>
        ...
        <tr class="text-center">
            ...
            <td>
                ...
                <a href="<?= site_url('rps/update_rps/'.$r->id_rps) ?>" class="btn btn-sm btn-warning" title="Edit">
...
<?php else : ?>
    <tr>
        <td colspan="6" class="text-center">Belum ada RPS yang diupload</td>
    </tr>
<?php endif; ?>
                            </tbody>
                        </table>
...
<script>
    ...
    function confirmDelete(id) {
        $('#deleteLink').attr('href', '<?= site_url("rps/delete_rps/"); ?>' + id);
