                ...
                <section class="section">
                    ...
                    <div class="card card-success">
                        ...
                        <?php foreach ($materi as $m) { ?>
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('guru/materi_edit') ?>" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?= $m->id ?>">
                                    <div class="form-group">
                                        <label for="nip">Nip</label>
                                        <input readonly id="nip" type="text" class="form-control" value="<?= $m->id_guru ?>" name="nama_guru">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="inputGroupFile01"> <?= $m->video ?> Upload Video
                                                    Materi Disini</label>
                                            </div>
                                        </div>
                                    </div>
