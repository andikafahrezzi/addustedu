                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="pilihan_a" id="pilihan_a" class="form-control" value="<?= set_value('pilihan_a', $soal->pilihan_a) ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="pilihan_b" id="pilihan_b" class="form-control" value="<?= set_value('pilihan_b', $soal->pilihan_b) ?>" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="pilihan_c" id="pilihan_c" class="form-control" value="<?= set_value('pilihan_c', $soal->pilihan_c) ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="pilihan_d" id="pilihan_d" class="form-control" value="<?= set_value('pilihan_d', $soal->pilihan_d) ?>" required>
